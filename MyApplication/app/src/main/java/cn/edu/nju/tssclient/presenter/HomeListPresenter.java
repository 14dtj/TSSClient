...
public class HomeListPresenter implements BasePresenter<ExamListView> {
    private Subscription subscription;
    private TeacherRepository repository;
    private ExamListView view;

    public HomeListPresenter(ExamListView view, TeacherRepository repository) {
        this.repository = repository;
        this.view = view;
    }

    public void getHomework(String username, String password, int courseId) {
        subscription = repository.getHomework(username, password, courseId)
